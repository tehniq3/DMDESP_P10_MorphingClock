 ...
 * v.4c - added info about UV and air quality
 */
...
// Craiova 
float latitude = 44.317; // 44.3302; //44.4268;
float longitude = 23.7949;  // 26.1025;
float altitudine = 100.0; // Craiova este la aproximativ 100m deasupra nivelului marii
...
String meteo1, meteo2, meteo3, meteo4, meteo5, meteo6, meteo7, meteo8;
byte ziuv = 0;
byte gata = 1;
